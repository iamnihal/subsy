...
if len(sys.argv) == 3:
    ...
    hash = get_hash(video)
    r = requests.get('http://api.thesubdb.com/?action=download&hash={}&language=en'.format(hash), headers={'User-Agent': 'SubDB/1.0 (Extractor/0.1; https://github.com/iamnihal/extractor)'})
